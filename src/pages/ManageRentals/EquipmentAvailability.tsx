      ...
      <Box sx={{ 
        ...
        <Stack spacing={4}>
          <Box>
            ...
            >
              {equipmentData.filter(e => e.status === "Available").length} of {equipmentData.length} items available for rent
            </Typography>
          </Box>
                      ...
                      <Stack spacing={1}>
                        ...
                        <Stack direction="row" spacing={2} alignItems="center">
                          <Chip
                            ...
                            size="small"
                            sx={{
                              bgcolor: `${getStatusChipColor(equipment.status)}20`,
                          ...
                          <Stack direction="row" spacing={1} alignItems="center">
                            <LocalDiningIcon sx={{ color: customColors.maroon, fontSize: '1rem' }} />
                      ...
                      <Stack spacing={1}>
                        <Stack direction="row" spacing={2} alignItems="center">
                          <Tooltip title="Last Rental Date">
                            <Stack direction="row" spacing={1} alignItems="center">
                              <AccessTimeIcon sx={{ color: customColors.maroon, fontSize: '1rem' }} />
                              <Typography variant="body2" sx={{ color: customColors.maroon }}>
                          ...
                          <Tooltip title="Next Available Date">
                            <Stack direction="row" spacing={1} alignItems="center">
                              <BuildIcon sx={{ color: customColors.maroon, fontSize: '1rem' }} />
                              <Typography variant="body2" sx={{ color: customColors.maroon }}>
