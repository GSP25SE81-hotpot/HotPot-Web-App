...
const HotpotGroupComboCreate: React.FC = () => {
  ...
  const groupIdentifier = urlParams.get("groupIdentifier");
        ...
        <CardContent>
          <Box sx={{ mb: 4 }}>
            <Typography
              ...
              fontWeight="bold"
            >
              🍲 Tạo mới thực đơn lẩu cho nhóm combo
            </Typography>
...
export default HotpotGroupComboCreate;
